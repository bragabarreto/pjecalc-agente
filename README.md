...
>
> Fallback alternativo (saída-só, sem portas abertas): um *quick tunnel* Cloudflare roda na VM (container `cloudflared`), mas seu subdomínio muda a cada reinício — por isso não é documentado como fixo.
