...
{{
  ...
  "verbas_deferidas": [
    {{
      ...
      "bases_calculo": "[lista — se a sentença mencionar EXPLICITAMENTE composição de base, ex: 'HE com integração de comissão' → emitir uma lista com 1+ objetos {{tipo_base: HISTORICO_SALARIAL|MAIOR_REMUNERACAO|SALARIO_MINIMO|SALARIO_DA_CATEGORIA|VALE_TRANSPORTE, historico_subtipo: ULTIMA_REMUNERACAO|SALARIO_BASE|ADICIONAL_INSALUBRIDADE_PAGO|<NOME_CUSTOMIZADO em UPPERCASE — quando a base aponta para um histórico custom criado em historico_salarial[]>|null (só quando tipo_base=HISTORICO_SALARIAL), proporcionalizar: bool, verba_compor: 'NOME_VERBA'|null (somar à base — ex: COMISSAO), integralizar: bool, divisor: CARGA_HORARIA|OUTRO_VALOR|DIAS_UTEIS|IMPORTADA_DO_CARTAO, multiplicador: float, outro_valor_divisor: float|null}}. OMITIR (lista vazia ou ausente) se a sentença não mencionar — defaults serão aplicados conforme característica da verba.] | null",
                ...
                "properties": {
                    ...
                    "bases_calculo":     {
                        ...
                        "items": {
                            ...
                            "properties": {
                                "tipo_base":            {"type": ["string","null"]},
                                "historico_subtipo":    {"type": ["string","null"]},
                                "proporcionalizar":     {"type": ["boolean","null"]},
                                "verba_compor":         {"type": ["string","null"]},
                                "integralizar":         {"type": ["boolean","null"]},
                                "divisor":              {"type": ["string","null"]},
                                "multiplicador":        {"type": ["number","null"]},
                                "outro_valor_divisor":  {"type": ["number","null"]},
                            },
                        },
                    },
