...
JSON_V2_RICHARLEN = {
  ...
  "verbas_principais": [
    # ── v01: Horas Extras 50% ────────────────────────────────────────────────
    {"id": "v01",
     "nome_sentenca": "Horas extras excedentes da 8ª diária e 44ª semanal",
     "estrategia_preenchimento": "expresso_direto",
     "expresso_alvo": "HORAS EXTRAS 50%",
     "nome_pjecalc": "HORAS EXTRAS 50%",
     "parametros": {
       "assunto_cnj": {"codigo": 2792, "label": "Horas Extras"},
       "valor": "CALCULADO",
       "caracteristica": "COMUM",
       "ocorrencia_pagamento": "MENSAL",
       "incidencias": {"irpf": True, "cs_inss": True, "fgts": True},
     ...
     "reflexos": [
       {"id": "r01-01", "verba_principal_id": "v01", "nome": "RSR sobre Horas Extras",
        "expresso_reflex_alvo": "REPOUSO SEMANAL REMUNERADO SOBRE HORAS EXTRAS"},
       {"id": "r01-02", "verba_principal_id": "v01", "nome": "Aviso Prévio sobre HE",
        "expresso_reflex_alvo": "AVISO PRÉVIO SOBRE HORAS EXTRAS"},
       {"id": "r01-03", "verba_principal_id": "v01", "nome": "Férias + 1/3 sobre HE",
        "expresso_reflex_alvo": "FERIAS + 1/3 SOBRE HORAS EXTRAS"},
       {"id": "r01-04", "verba_principal_id": "v01", "nome": "13º Salário sobre HE",
        "expresso_reflex_alvo": "13º SALARIO SOBRE HORAS EXTRAS"},
       {"id": "r01-05", "verba_principal_id": "v01", "nome": "FGTS sobre HE",
        "expresso_reflex_alvo": "FGTS SOBRE HORAS EXTRAS"},
       {"id": "r01-06", "verba_principal_id": "v01", "nome": "FGTS 40% sobre HE",
        "expresso_reflex_alvo": "FGTS 40% SOBRE HORAS EXTRAS"},
       {"id": "r01-07", "verba_principal_id": "v01", "nome": "Multa 477 sobre HE",
        "expresso_reflex_alvo": "MULTA 477 SOBRE HORAS EXTRAS"},
     ]},
    # ── v02: Diferença Salarial ──────────────────────────────────────────────
    {"id": "v02",
     "nome_sentenca": "Integração do salário pago por fora — diferenças rescisórias",
     "estrategia_preenchimento": "expresso_direto",
     "expresso_alvo": "DIFERENÇA SALARIAL",
     "nome_pjecalc": "DIFERENÇA SALARIAL",
     "parametros": {
       "assunto_cnj": {"codigo": 2581, "label": "Remuneração, Verbas Indenizatórias e Benefícios"},
       "valor": "INFORMADO",
       "caracteristica": "COMUM",
       "ocorrencia_pagamento": "MENSAL",
       "incidencias": {"irpf": True, "cs_inss": True, "fgts": True},
     ...
     "reflexos": [
       {"id": "r02-01", "verba_principal_id": "v02",
        "nome": "Aviso Prévio sobre Diferença Salarial",
        "expresso_reflex_alvo": "AVISO PRÉVIO SOBRE DIFERENÇA SALARIAL"},
       {"id": "r02-02", "verba_principal_id": "v02",
        "nome": "Férias + 1/3 sobre Diferença Salarial",
        "expresso_reflex_alvo": "FERIAS + 1/3 SOBRE DIFERENÇA SALARIAL"},
       {"id": "r02-03", "verba_principal_id": "v02",
        "nome": "13º Salário sobre Diferença Salarial",
        "expresso_reflex_alvo": "13º SALARIO SOBRE DIFERENÇA SALARIAL"},
       {"id": "r02-04", "verba_principal_id": "v02",
        "nome": "FGTS sobre Diferença Salarial",
        "expresso_reflex_alvo": "FGTS SOBRE DIFERENÇA SALARIAL"},
       {"id": "r02-05", "verba_principal_id": "v02",
        "nome": "FGTS 40% sobre Diferença Salarial",
        "expresso_reflex_alvo": "FGTS 40% SOBRE DIFERENÇA SALARIAL"},
       {"id": "r02-06", "verba_principal_id": "v02",
        "nome": "Multa 477 sobre Diferença Salarial",
        "expresso_reflex_alvo": "MULTA 477 SOBRE DIFERENÇA SALARIAL"},
     ]},
    # ── v03: Dano Moral — doença ocupacional ────────────────────────────────
    {"id": "v03",
     "nome_sentenca": "Indenização por danos morais — doença ocupacional",
     "estrategia_preenchimento": "expresso_direto",
     ...
     "parametros": {
       ...
       "incidencias": {"irpf": False, "cs_inss": False, "fgts": False},
       "valor_devido": {"tipo": "INFORMADO", "valor_informado_brl": 15000.00},
     },
     "reflexos": []},
    # ── v04: Estabilidade Acidentária (expresso_adaptado) ───────────────────
    {"id": "v04",
     "nome_sentenca": "Indenização substitutiva da estabilidade acidentária — 12 meses",
     "estrategia_preenchimento": "expresso_adaptado",
     "expresso_alvo": "INDENIZAÇÃO ADICIONAL",
     "nome_pjecalc": "INDENIZAÇÃO ESTABILIDADE ACIDENTÁRIA - L 8213 ART 118",
     "parametros": {
       "assunto_cnj": {"codigo": 2581, "label": "Remuneração, Verbas Indenizatórias e Benefícios"},
       "valor": "INFORMADO",
       "caracteristica": "COMUM",
     ...
     "reflexos": [
       {"id": "r04-01", "verba_principal_id": "v04",
        "nome": "Férias + 1/3 sobre Estabilidade Acidentária",
        "estrategia_reflexa": "manual",
        "parametros_override": {"caracteristica": "FERIAS", "incidencias": {"fgts": False}}},
       {"id": "r04-02", "verba_principal_id": "v04",
        "nome": "13º Salário sobre Estabilidade Acidentária",
        "estrategia_reflexa": "manual",
        "parametros_override": {"caracteristica": "DECIMO_TERCEIRO_SALARIO", "incidencias": {"fgts": False}}},
       {"id": "r04-03", "verba_principal_id": "v04",
        "nome": "FGTS sobre Estabilidade Acidentária",
        "estrategia_reflexa": "manual",
        "parametros_override": {"caracteristica": "COMUM", "incidencias": {"fgts": True}}},
     ]},
    # ── v05: Lei 9.029/95 — remuneração em dobro (expresso_adaptado) ────────
    {"id": "v05",
     "nome_sentenca": "Remuneração em dobro — Lei 9.029/95",
     "estrategia_preenchimento": "expresso_adaptado",
     "expresso_alvo": "INDENIZAÇÃO POR DANO MORAL",
     "nome_pjecalc": "INDENIZAÇÃO LEI 9.029/95 - DISPENSA DISCRIMINATÓRIA",
     "parametros": {
       "assunto_cnj": {"codigo": 2581, "label": "Remuneração, Verbas Indenizatórias e Benefícios"},
       "valor": "CALCULADO",
       "caracteristica": "COMUM",
     ...
     "reflexos": [
       {"id": "r05-01", "verba_principal_id": "v05",
        "nome": "13º Salário sobre Lei 9.029/95",
        "estrategia_reflexa": "manual",
        "parametros_override": {"caracteristica": "DECIMO_TERCEIRO_SALARIO", "incidencias": {"fgts": False}}},
       {"id": "r05-02", "verba_principal_id": "v05",
        "nome": "Férias + 1/3 sobre Lei 9.029/95",
        "estrategia_reflexa": "manual",
        "parametros_override": {"caracteristica": "FERIAS", "incidencias": {"fgts": False}}},
       {"id": "r05-03", "verba_principal_id": "v05",
        "nome": "FGTS sobre Lei 9.029/95",
        "estrategia_reflexa": "manual",
        "parametros_override": {"caracteristica": "COMUM", "incidencias": {"fgts": True}}},
     ]},
    # ── v06: Dano Moral — dispensa discriminatória ───────────────────────────
    {"id": "v06",
     "nome_sentenca": "Indenização por danos morais — dispensa discriminatória",
     "estrategia_preenchimento": "expresso_direto",
     "expresso_alvo": "INDENIZAÇÃO POR DANO MORAL",
     "nome_pjecalc": "INDENIZAÇÃO POR DANO MORAL",
     "parametros": {
    ...
    # ── v07: Multa art. 477 ──────────────────────────────────────────────────
    {"id": "v07",
     "nome_sentenca": "Multa do art. 477, §8º, da CLT",
     "estrategia_preenchimento": "expresso_direto",
